...
write.dbf(c_DECIL_ES,file = "Nacional INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Nacional NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional NO por fuente por DECIL LS 2010.dbf")
...
prueba<-c_DECIL_ES%>%
  mutate(prueba=TRABAJO2018+RENTAS2018+JUBILACION2018+BECAS2018+DONATIVOS2018+REMESAS2018+BENEGOBIERNO2018+`TRANS HOG2018`+`TRANS INST2018`+`ESTIM ALQU2018`+`OTROS INGRESOS2018`)
all.equal(prueba$`ING COR2018`,prueba$prueba)

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")

write.dbf(c_DECIL_ES,file = "Nacional Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional Ingresos por fuente por DECIL LS 2018.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Nacional NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional NO Ingresos por fuente por DECIL LS 2018.dbf")
...
GIC<-cuadro_final%>%
  ...
  geom_col()+
  labs(title = "Growth Incidence Curve Nacional 2010-2018",
       y="Growth rate (total)",
       x="Decile",
       fill="Source of
  income")+
...
GIC_por_raza<-GIC_por_raza_derretida%>%
  ...
  labs(title = "Growth Incidence Curve Nacional by ethnic group 2010-2018",
       fill="Ethnic group:",
       y="Growth rate (total)",
       x="Decile")+
  scale_y_continuous(breaks=seq(min,max,1))+
...
design_2018 <-  svydesign(id=~as.factor(upm),strata=~est_dis,data=Conc2018,weights=~factor)
...
write.dbf(c_DECIL_ES,file = "Nacional URBANO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional URBANO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional URBANO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional URBANO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional URBANO por fuente por DECIL LS 2010.dbf")

rm(list=ls())



########## Ingresos por fuente por Decil RURAL 2010 ##########
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
write.dbf(c_DECIL_ES,file = "Nacional RURAL por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional RURAL por fuente por DECIL errores standard 2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional URBANO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional URBANO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional URBANO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional URBANO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional URBANO Ingresos por fuente por DECIL LS 2018.dbf")

rm(list=ls())

########## Ingresos por fuente por Decil RURAL 2018 ############
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional RURAL Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional RURAL Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional RURAL Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional RURAL Ingresos por fuente por DECIL LI 2018.dbf")
...
########## Ingresos por fuente por decil Urbano indigena 2010 #######
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH 2010/ENIGH2010")
Conc2010<-read.dbf("Conc2010_urban.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Nacional URBANO INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional URBANO INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional URBANO INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional URBANO INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional URBANO INDIGENA por fuente por DECIL LS 2010.dbf")

rm(list=ls())


########## Ingresos por fuente por decil Urbano NO indigena 2010 #######
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
write.dbf(c_DECIL_ES,file = "Nacional URBANO NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional URBANO NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional URBANO NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional URBANO NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional URBANO NO por fuente por DECIL LS 2010.dbf")

rm(list=ls())

########## Ingresos por fuente por decil RURAL indigena 2010 #######
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH 2010/ENIGH2010")
Conc2010<-read.dbf("Conc2010_rural.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Nacional Rural INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional Rural INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional Rural INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional Rural INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional Rural INDIGENA por fuente por DECIL LS 2010.dbf")

rm(list=ls())


########## Ingresos por fuente por decil RURAL NO indigena 2010 #######
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
write.dbf(c_DECIL_ES,file = "Nacional Rural NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Nacional Rural NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Nacional Rural NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Nacional Rural NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Nacional Rural NO por fuente por DECIL LS 2010.dbf")

rm(list=ls())


########## Ingresos por fuente por Decil URBANO INDIGENA 2018 #########
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH 2018/ENIGH2018")
Conc2018<-read.dbf("Conc2018_urban.dbf",as.is = T)
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional URBANO INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional URBANO INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional URBANO INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional URBANO INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional URBANO INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")

rm(list=ls())

########## Ingresos por fuente por Decil URBANO NO 2018 #########
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional URBANO NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional URBANO NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional URBANO NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional URBANO NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional URBANO NO Ingresos por fuente por DECIL LS 2018.dbf")

rm(list=ls())

########## Ingresos por fuente por Decil RURAL INDIGENA 2018 #########
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH 2018/ENIGH2018")
Conc2018<-read.dbf("Conc2018_rural.dbf",as.is = T)
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional RURAL INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional RURAL INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional RURAL INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional RURAL INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional RURAL INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")

rm(list=ls())

########## Ingresos por fuente por Decil RURAL NO 2018 #########
library(foreign)
library(survey)
library(doBy)
library(reldist)
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/GIC Nacional 2010 - 2018/GIC_nacional_2010_2018")
write.dbf(c_DECIL_ES,file = "Nacional RURAL NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Nacional RURAL NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Nacional RURAL NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Nacional RURAL NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Nacional RURAL NO Ingresos por fuente por DECIL LS 2018.dbf")

rm(list=ls())

########## GIC por raza por fuente Rural ###############
library(foreign)
library(tidyverse)
library(plotly)
library(htmlwidgets)
...
Deciles_por_fuente_2010_indigena<-read.dbf("Nacional Rural INDIGENA por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2010<-read.dbf("Nacional RURAL por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018<-read.dbf("Nacional RURAL Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
Deciles_por_fuente_2010<-read.dbf("Nacional URBANO por fuente por DECIL estimaciones 2010.dbf")
...
Deciles_por_fuente_2018<-read.dbf("Nacional URBANO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
#ahora, a juntarlos
library(ggpubr)
figure<-ggarrange(GIC_rural,GIC_urban,
                  labels = c("Rural","Urban"),
                  ncol = 1, nrow = 2)
figure<-annotate_figure(figure,
                top = text_grob("Mexico
Growth Incidence Curve 2010-2018
by source of income and size of the settlement", color = "black", face = "bold", size = 14),
                bottom = text_grob("Rural areas are defined as settlements with less than 2,500 habitants by the National Institute of Geography and Statistics.", color = "black",
                                   hjust = 1, x = 1, face = "italic", size = 10),
                left = text_grob("Growth rate (total)", color = "black", rot = 90))
